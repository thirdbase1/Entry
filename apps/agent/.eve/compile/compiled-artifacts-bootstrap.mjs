...
import { installBundledCompiledArtifacts } from "/tmp/entry_clean/node_modules/eve/dist/src/runtime/loaders/bundled-artifacts.js";
import { installEveWorkflowQueueNamespace } from "/tmp/entry_clean/node_modules/eve/dist/src/internal/workflow/queue-namespace.js";

installEveWorkflowQueueNamespace("agent");

// Generated by eve. Do not edit by hand.

import * as module_0 from "/tmp/entry_clean/apps/agent/agent/agent.ts";
import * as module_1 from "/tmp/entry_clean/apps/agent/agent/channels/eve.ts";
import * as module_2 from "/tmp/entry_clean/apps/agent/agent/instructions/dynamic.ts";
import * as module_3 from "/tmp/entry_clean/apps/agent/agent/sandbox/sandbox.ts";
import * as module_4 from "/tmp/entry_clean/apps/agent/agent/tools/browser_use.ts";
import * as module_5 from "/tmp/entry_clean/apps/agent/agent/tools/choose.ts";
import * as module_6 from "/tmp/entry_clean/apps/agent/agent/tools/code_artifact.ts";
import * as module_7 from "/tmp/entry_clean/apps/agent/agent/tools/doc_compose.ts";
import * as module_8 from "/tmp/entry_clean/apps/agent/agent/tools/make_it_real.ts";
import * as module_9 from "/tmp/entry_clean/apps/agent/agent/tools/python_coding.ts";
import * as module_10 from "/tmp/entry_clean/apps/agent/agent/tools/task_analysis.ts";
import * as module_11 from "/tmp/entry_clean/apps/agent/agent/tools/web_crawl.ts";
import * as module_12 from "/tmp/entry_clean/apps/agent/agent/tools/web_search.ts";
import * as module_13 from "/tmp/entry_clean/apps/agent/agent/subagents/claude/agent.ts";
import * as module_14 from "/tmp/entry_clean/apps/agent/agent/subagents/gemini/agent.ts";
import * as module_15 from "/tmp/entry_clean/apps/agent/agent/subagents/gpt/agent.ts";
...
const metadata = {
  "compile": {
    "moduleMap": {
      ...
      "sha256": "1a43153927f84643c69254e1bdafef3578f6bdb9d99d4fc6942933ff3bda78f3"
    }
  },
  "discovery": {
    "diagnostics": {
    ...
    "manifest": {
      ...
      "sha256": "be45c795f0eb39003e0c17839bf3216f8515babf2e98bb1179ab1058e64c1147"
    },
    "sourceGraphHash": "be2a373570f62f9ea46331c96562cf3442fe75356312214d419f3687d29aca78",
    "summary": {
      "errors": 0,
      "warnings": 0
    }
...
const manifest = {
  "agentRoot": "/tmp/entry_clean/apps/agent/agent",
  "appRoot": "/tmp/entry_clean/apps/agent",
  "channels": [
    {
      "kind": "channel",
      "name": "eve",
  ...
  "sandbox": {
    ...
    "sourceHash": "ae59810768375dfc0aec76a1e521260208be8e4edd1fa53d15ad8fc5e2d5b8b1",
  ...
  "skills": [
    {
      ...
      "logicalPath": "skills/agent-browser/SKILL.md",
      ...
      "name": "agent-browser",
      "rootPath": "/tmp/entry_clean/apps/agent/agent/skills/agent-browser",
      "skillId": "agent-browser",
      "skillFilePath": "/tmp/entry_clean/apps/agent/agent/skills/agent-browser/SKILL.md",
      "sourceId": "skills/agent-browser/SKILL.md",
      "sourceKind": "skill-package"
    },
    {
      "description": "Deploy applications and websites to Vercel. Use when the user requests deployment actions like \"deploy my app\", \"deploy and give me the link\", \"push this live\", or \"create a preview deployment\".",
      "logicalPath": "skills/deploy-to-vercel/SKILL.md",
      ...
      "rootPath": "/tmp/entry_clean/apps/agent/agent/skills/deploy-to-vercel",
      "skillId": "deploy-to-vercel",
      "skillFilePath": "/tmp/entry_clean/apps/agent/agent/skills/deploy-to-vercel/SKILL.md",
      "sourceId": "skills/deploy-to-vercel/SKILL.md",
      "sourceKind": "skill-package"
    },
    {
    ...
    },
    {
      ...
      "rootPath": "/tmp/entry_clean/apps/agent/agent/skills/web-design-guidelines",
      "skillId": "web-design-guidelines",
      "skillFilePath": "/tmp/entry_clean/apps/agent/agent/skills/web-design-guidelines/SKILL.md",
      "sourceId": "skills/web-design-guidelines/SKILL.md",
      "sourceKind": "skill-package"
    },
    {
      ...
      "logicalPath": "skills/writing-guidelines/SKILL.md",
      ...
      "rootPath": "/tmp/entry_clean/apps/agent/agent/skills/writing-guidelines",
      "skillId": "writing-guidelines",
      "skillFilePath": "/tmp/entry_clean/apps/agent/agent/skills/writing-guidelines/SKILL.md",
      "sourceId": "skills/writing-guidelines/SKILL.md",
      "sourceKind": "skill-package"
    }
  ],
  "tools": [
    {
      "description": "Autonomously drive a real Chrome browser to complete a task: navigate, click, fill forms, read page content, take screenshots. Give it a natural-language task description; it plans and executes the necessary browser steps itself and returns a markdown summary of what it found/did.",
      "inputSchema": {
        ...
        "properties": {
          "task": {
            "type": "string",
            "description": "Natural-language description of what the browser should accomplish"
          }
        },
        "required": [
          "task"
      ...
      "logicalPath": "tools/browser_use.ts",
      "name": "browser_use",
      "sourceId": "tools/browser_use.ts",
      "sourceKind": "module"
    },
    {
      "description": "Present multiple options to the user for selection. The user can either choose from the provided options or provide their own input. Write option text in the language the user is using.",
      "inputSchema": {
        "$schema": "http://json-schema.org/draft-07/schema#",
        "type": "object",
        "properties": {
      ...
      "logicalPath": "tools/choose.ts",
      "name": "choose",
      "sourceId": "tools/choose.ts",
      "sourceKind": "module"
    },
    {
      ...
      "logicalPath": "tools/code_artifact.ts",
      "name": "code_artifact",
      "sourceId": "tools/code_artifact.ts",
      "sourceKind": "module"
    },
    {
      ...
      "logicalPath": "tools/doc_compose.ts",
      "name": "doc_compose",
      "sourceId": "tools/doc_compose.ts",
      "sourceKind": "module"
    },
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          "instructions": {
            "description": "User's special requirements.",
            "type": "string"
          },
          "markdown": {
            "type": "string",
      ...
      "logicalPath": "tools/make_it_real.ts",
      "name": "make_it_real",
      "outputSchema": {
        "$schema": "http://json-schema.org/draft-07/schema#",
        "type": "object",
        "properties": {
          "content": {
            "type": "string",
            "description": "The improved markdown content with a more beautiful layout/slideshow structure"
          }
        },
        "required": [
          "content"
      ...
      "sourceId": "tools/make_it_real.ts",
      "sourceKind": "module"
    },
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          "requirements": {
            "type": "string",
            "description": "The requirements to generate python code for"
          }
        },
        "required": [
          "requirements"
      ...
      "logicalPath": "tools/python_coding.ts",
      "name": "python_coding",
      "outputSchema": {
        "$schema": "http://json-schema.org/draft-07/schema#",
        "type": "object",
      ...
      "sourceId": "tools/python_coding.ts",
      "sourceKind": "module"
    },
    {
      "description": "Analyze a user task to determine if it needs to be broken down into phases, estimate the number of steps required, create a todo list, and identify which tools might be needed for each step. Use this whenever you encounter a potentially complex task (report creation, data analysis, non-trivial code) to confirm whether it needs breaking down.",
      "inputSchema": {
        "$schema": "http://json-schema.org/draft-07/schema#",
        "type": "object",
        "properties": {
      ...
      "logicalPath": "tools/task_analysis.ts",
      "name": "task_analysis",
      "outputSchema": {
        "$schema": "http://json-schema.org/draft-07/schema#",
        "type": "object",
      ...
      "sourceId": "tools/task_analysis.ts",
      "sourceKind": "module"
    },
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          "url": {
            "type": "string",
            "description": "The URL to crawl (including http:// or https://)"
          }
        },
        "required": [
          "url"
      ...
      "logicalPath": "tools/web_crawl.ts",
      "name": "web_crawl",
      "sourceId": "tools/web_crawl.ts",
      "sourceKind": "module"
    },
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          ...
          "mode": {
            "default": "AUTO",
            "description": "MUST for thorough/high-quality retrieval, AUTO for a faster default.",
            "type": "string",
            "enum": [
              "MUST",
              "AUTO"
  ...
  "workspaceResourceRoot": {
    "contentHash": "8e5fe00b28d8a6d6bf0ddda00aa016a876db3a159ae487435182fb961d9d8942",
  ...
  "subagentEdges": [
    {
      "childNodeId": "subagents/claude",
      "parentNodeId": "__root__"
    },
    {
      "childNodeId": "subagents/gemini",
      "parentNodeId": "__root__"
    },
    {
      "childNodeId": "subagents/gpt",
      "parentNodeId": "__root__"
    }
  ],
  "subagents": [
    {
      "agent": {
        "agentRoot": "/tmp/entry_clean/apps/agent/agent/subagents/claude",
        "appRoot": "/tmp/entry_clean/apps/agent",
        "channels": [],
        "connections": [],
        "config": {
          ...
          "compaction": {},
          "description": "Handles the user's turn using Anthropic's Claude model specifically. Delegate here ONLY when the turn's context explicitly requests Claude/Anthropic as the preferred model.",
          "model": {
            "id": "anthropic/claude-sonnet-5",
            "routing": {
              "kind": "gateway",
        ...
        "workspaceResourceRoot": {
          ...
          "logicalPath": "workspace-resources/subagents/claude",
          "rootEntries": []
        },
        "instructions": {
          "name": "instructions",
      ...
      "description": "Handles the user's turn using Anthropic's Claude model specifically. Delegate here ONLY when the turn's context explicitly requests Claude/Anthropic as the preferred model.",
      "entryPath": "/tmp/entry_clean/apps/agent/agent/subagents/claude",
      "logicalPath": "subagents/claude",
      "name": "claude",
      "nodeId": "subagents/claude",
      "rootPath": "/tmp/entry_clean/apps/agent/agent/subagents/claude",
      "sourceId": "subagents/claude",
      "sourceKind": "module"
    },
    {
      "agent": {
        "agentRoot": "/tmp/entry_clean/apps/agent/agent/subagents/gemini",
        "appRoot": "/tmp/entry_clean/apps/agent",
        "channels": [],
        "connections": [],
        "config": {
          ...
          "compaction": {},
          "description": "Handles the user's turn using Google's Gemini model specifically. Delegate here ONLY when the turn's context explicitly requests Gemini/Google as the preferred model.",
          "model": {
        ...
        "workspaceResourceRoot": {
          "contentHash": "5777dd4d87493e836b5597e87f6b3d07482c551341171ea7836996b231207c7b",
          "logicalPath": "workspace-resources/subagents/gemini",
          "rootEntries": []
        },
        "instructions": {
          "name": "instructions",
      ...
      "description": "Handles the user's turn using Google's Gemini model specifically. Delegate here ONLY when the turn's context explicitly requests Gemini/Google as the preferred model.",
      "entryPath": "/tmp/entry_clean/apps/agent/agent/subagents/gemini",
      "logicalPath": "subagents/gemini",
      "name": "gemini",
      "nodeId": "subagents/gemini",
      "rootPath": "/tmp/entry_clean/apps/agent/agent/subagents/gemini",
      "sourceId": "subagents/gemini",
      "sourceKind": "module"
    },
    {
      "agent": {
        "agentRoot": "/tmp/entry_clean/apps/agent/agent/subagents/gpt",
        "appRoot": "/tmp/entry_clean/apps/agent",
        "channels": [],
        "connections": [],
        "config": {
          ...
          "compaction": {},
          "description": "Handles the user's turn using OpenAI's GPT model specifically. Delegate here ONLY when the turn's context explicitly requests GPT/OpenAI as the preferred model.",
          "model": {
        ...
        "workspaceResourceRoot": {
          "contentHash": "5777dd4d87493e836b5597e87f6b3d07482c551341171ea7836996b231207c7b",
          "logicalPath": "workspace-resources/subagents/gpt",
          "rootEntries": []
        },
        "instructions": {
          "name": "instructions",
      ...
      "description": "Handles the user's turn using OpenAI's GPT model specifically. Delegate here ONLY when the turn's context explicitly requests GPT/OpenAI as the preferred model.",
      "entryPath": "/tmp/entry_clean/apps/agent/agent/subagents/gpt",
      "logicalPath": "subagents/gpt",
      "name": "gpt",
      "nodeId": "subagents/gpt",
      "rootPath": "/tmp/entry_clean/apps/agent/agent/subagents/gpt",
      "sourceId": "subagents/gpt",
      "sourceKind": "module"
    }
  ],
  "version": 32
