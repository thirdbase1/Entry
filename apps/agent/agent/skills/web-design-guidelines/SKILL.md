...
metadata:
  author: vercel
  version: "1.0.0"
  argument-hint: "[file or pattern to review]"
---
...
- Headings hierarchical `<h1>` through `<h6>`; include skip link for main content
...
- Ampersand over "and" where space-constrained
...
src/Button.tsx:67 - transition: all, list properties instead

## src/Modal.tsx

src/Modal.tsx:12 - missing overscroll-behavior: contain
src/Modal.tsx:34 - three dots should be ellipsis character
