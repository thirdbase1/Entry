...
/**
 * Ported 1:1 from components/ui/text-animate/blur-up.tsx.
 * Full text animation component with multiple animation variants.
 * Splits text by word/character/line and applies staggered framer-motion
 * animations (fadeIn, blurIn, blurInUp, slideUp, scaleUp, etc.).
 */
import {
  AnimatePresence,
  motion,
